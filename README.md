...
<br>
'Absolutno', 'Acamar', 'Achernar', 'Achird', 'Acrab', 'Acrux', 'Acubens', 'Adhafera', 'Adhara', 'Adhil', 'Ain', 'Ainalrami', 'Aiolos', 'Aladfar', 'Alasia', 'Alaybasan', 'Albaldah', 'Albali', 'Albireo', 'Alchiba', 'Alcor', 'Alcyone', 'Aldebaran', 'Alderamin', 'Aldhanab', 'Aldhibah', 'Aldulfin', 'Alfarasalkamil', 'Alfirk', 'Algedi', 'Algenib', 'Algieba', 'Algol', 'Algorab', 'Alhena', 'Alioth', 'Aljanah', 'Alkaid', 'Alkalurops', 'Alkaphrah', 'Alkarab', 'Alkes', 'Almaaz', 'Almach', 'Alnair', 'Alnasl', 'Alnilam', 'Alnitak', 'Alniyat', 'Alphard', 'Alphecca', 'Alpheratz', 'Alpherg', 'Alrakis', 'Alrescha', 'Alruba', 'Alrumh', 'Alsafi', 'Alsciaukat', 'Alsephina', 'Alshain', 'Alshat', 'Altair', 'Altais', 'Alterf', 'Aludra', 'Alula Australis', 'Alula Borealis', 'Alya', 'Alzirr', 'Amadioha', 'Amansinaya', 'Anadolu', 'Ancha', 'Angetenar', 'Aniara', 'Ankaa', 'Anser', 'Antares', 'Antinous', 'Apamvatsa', 'Apdu', 'Arcalís', 'Arcturus', 'Arkab Posterior', 'Arkab Prior', 'Arneb', 'Ascella', 'Asellus Australis', 'Asellus Borealis', 'Ashlesha', 'Aspidiske', 'Asterope', 'Atakoraka', 'Athebyne', 'Atik', 'Atlas', 'Atria', 'Avior', 'Axólotl', 'Ayeyarwady', 'Azelfafage', 'Azha', 'Azmidi', 'Añañuca', 'Bade', 'Baekdu', 'Bagu', 'Bajamar Star', 'Bake-eo', "Barnard's Star", 'Baten Kaitos', 'Batsũ̀', 'Beemim', 'Beid', 'Belel', 'Bellatrix', 'Berehynia', 'Betelgeuse', 'Bharani', 'Bibhā', 'Biham', 'Blaze Star', 'Bodu', 'Bosona', 'Botein', 'Brachium', 'Bubup', 'Buna', 'Bunda', 'Bélénos', 'Calvera', 'Canopus', 'Capella', 'Caph', 'Castor', 'Castula', 'Cebalrai', 'Ceibo', 'Celaeno', 'Cervantes', 'Cexing', 'Chalawan', 'Chamukuy', 'Chaophraya', 'Chara', 'Chasoň', 'Chechia', 'Chertan', 'Citadelle', 'Citalá', 'Cocibolca', 'Copernicus', 'Cor Caroli', 'Cujam', 'Cursa', 'Custos', 'Dabih', 'Dajiangjunbei', 'Dalim', 'Danfeng', 'Darlugal', 'Deltoton', 'Deneb', 'Deneb Algedi', 'Denebola', 'Diadem', 'Dilmun', 'Dingolay', 'Diphda', 'Diya', 'Dofida', 'Dombay', 'Dschubba', 'Dubhe', 'Dziban', 'Dìwö', 'Ebla', 'Edasich', 'Electra', 'Elgafar', 'Elkurud', 'Elnath', 'Eltanin', 'Emiw', 'Enif', 'Errai', 'Fafnir', 'Fang', 'Fawaris', 'Felis', 'Felixvarela', 'Filetdor', 'Flegetonte', 'Fomalhaut', 'Formosa', 'Franz', 'Fulu', 'Fumalsamakah', 'Funi', 'Furud', 'Fuyue', 'Gacrux', 'Gaja', 'Gakyid', 'Gang', 'Gar', 'Garnet Star', 'Geminga', 'Genghe', 'Giausar', 'Gienah', 'Ginan', 'Gloas', 'Gnomon', 'Gomeisa', 'Grumium', 'Guahayona', 'Gudja', 'Gumala', 'Guniibuu', 'Hadar', 'Haedus', 'Hamal', 'Hassaleh', 'Hatysa', 'Helvetios', 'Heng', 'Heze', 'Hoerikwaggo', 'Hoggar', 'Holoea', 'Homam', 'Honores', 'Horna', 'Huagai', 'Hunahpú', 'Hunor', 'Hydor', 'Iklil', 'Illyrian', 'Imai', 'Inquill', 'Intan', 'Intercrus', 'Irena', 'Itonda', 'Izar', 'Jabbah', 'Jishui', 'Junnanmen', 'Kaewkosin', 'Kaffaljidhma', 'Kaffalmusalsala', 'Kalasungsang', 'Kalausi', 'Kamelos', 'Kamuy', 'Kang', 'Karaka', 'Kaus Australis', 'Kaus Borealis', 'Kaus Media', 'Kaveh', 'Keid', 'Khambalia', 'Kitalpha', 'Kochab', 'Koeia', 'Koit', 'Komondor', 'Kornephoros', 'Kosjenka', 'Kraz', 'Krios', 'Kronos', 'Kui', 'Kulou', 'Kurhah', 'La Superba', 'Lang-exster', 'Larawag', 'Leepwal', 'Lerna', 'Lesath', 'Libertas', 'Lich', 'Liesma', 'Lilii Borea', 'Lionrock', 'Lucilinburhuc', 'Lumbung', 'Lusitânia', 'Maasym', 'Macondo', 'Maenalus', 'Mago', 'Mahasim', 'Mahsati', 'Maia', 'Malmok', 'Marfik', 'Markab', 'Markeb', 'Marsic', 'Maru', 'Matar', 'Matza', 'Mazaalai', 'Mebsuta', 'Megrez', 'Meissa', 'Mekbuda', 'Meleph', 'Menkalinan', 'Menkar', 'Menkent', 'Menkib', 'Merak', 'Merga', 'Meridiana', 'Merope', 'Mesarthim', 'Miaplacidus', 'Mimosa', 'Minchir', 'Minelauva', 'Mintaka', 'Mira', 'Mirach', 'Miram', 'Mirfak', 'Mirzam', 'Misam', 'Mizar', 'Moldoveanu', 'Montuno', 'Morava', 'Moriah', 'Mothallah', 'Mouhoun', 'Mpingo', 'Muliphein', 'Muphrid', 'Muscida', 'Musica', 'Muspelheim', 'Márohu', 'Mönch', 'Naga', 'Nahn', 'Naledi', 'Naos', 'Nashira', 'Natasha', 'Nekkar', 'Nembus', 'Nenque', 'Nervia', 'Nganurganity', 'Nihal', 'Nikawiy', 'Noquisi', 'Nosaxa', 'Nunki', 'Nusakan', 'Nushagak', 'Nyamien', 'Násti', 'Ogma', 'Okab', 'Orkaria', 'Paikauhale', 'Paloma', 'Paradys', 'Parumleo', 'Peacock', 'Petra', 'Phact', 'Phecda', 'Pherkad', 'Pherkad Minor', 'Phoenicia', 'Phyllon Kissinou', 'Piautos', 'Pincoya', 'Ping', 'Pipirima', 'Pipit', 'Pipoltr', 'Pleione', 'Poerava', 'Polaris', 'Polaris Australis', 'Polis', 'Pollux', 'Porrima', 'Praecipua', 'Prima Hyadum', 'Procyon', 'Propus', 'Proxima Centauri', 'Pulcherrima', 'Qigong', 'Quadrans', 'Ramus', 'Ran', 'Rana', 'Rangifer', 'Rapeto', 'Rasalas', 'Rasalgethi', 'Rasalhague', 'Rasalnaqa', 'Rastaban', 'Regulus', 'Revati', 'Rhombus', 'Rigel', 'Rigil Kentaurus', 'Rosalíadecastro', 'Rotanev', 'Ruchbah', 'Rukbat', 'Sabik', 'Saclateni', 'Sadachbia', 'Sadalbari', 'Sadalmelik', 'Sadalsuud', 'Sadr', 'Safina', 'Sagarmatha', 'Saiph', 'Salm', 'Sansuna', 'Sapaki', 'Sargas', 'Sarin', 'Sarvvis', 'Sceptrum', 'Scheat', 'Schedar', 'Secunda Hyadum', 'Segin', 'Seginus', 'Sham', 'Shama', 'Shangcheng', 'Shangwei', 'Shaomin', 'Shaowei', 'Sharjah', 'Shatabhisha', 'Shaula', 'Sheliak', 'Shengong', 'Sheratan', 'Shimu', 'Sika', 'Sirius', 'Situla', 'Skat', 'Solaris', 'Solitaire', 'Spica', 'Stella Ludoviciana', 'Stellio', 'Sterrennacht', 'Stribor', 'Sualocin', 'Subra', 'Suhail', 'Sulafat', 'Syrma', 'Sāmaya', 'Tabit', 'Taika', 'Taiyangshou', 'Taiyi', 'Talitha', 'Tangra', 'Tania Australis', 'Tania Borealis', 'Tapecue', 'Tarandus', 'Tarazed', 'Tarf', 'Taygeta', 'Tegmine', 'Tejat', 'Tengshe', 'Tepiamenit', 'Terebellum', 'Tevel', 'Theemin', 'Thuban', 'Tiaki', 'Tianfu', 'Tianguan', 'Tiansi', 'Tianyi', 'Timir', 'Tislit', 'Titawin', 'Tojil', 'Toliman', 'Tonatiuh', 'Tonglingxing', 'Torcular', 'Triminus', 'Tuiren', 'Tupi', 'Tupã', 'Tureis', 'Tusizuo', 'Udang', 'Udkadua', 'Ukdah', 'Uklun', 'Unukalhai', 'Uridim', 'Uruk', 'Uúba', 'Vega', 'Veritate', 'Vindemiatrix', 'Wasat', 'Wattle', 'Wazn', 'Wezen', 'Wouri', 'Wurren', 'Xami', 'Xamidimura', 'Xihe', 'Xuange', 'Yed Posterior', 'Yed Prior', 'Yildun', 'Yunü', 'Yuyu', 'Zaniah', 'Zaurak', 'Zavijava', 'Zembra', 'Zhang', 'Zhou', 'Zibal', 'Zosma', 'Zubenelgenubi', 'Zubenelhakrabi', 'Zubeneschamali', 'Áldu'
</details>
