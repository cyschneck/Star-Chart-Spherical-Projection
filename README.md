...
```
Returns `{'Thuban': {'Declination': np.float64(87.7600158821428), 'RA': '02.43.17'}, 'Vega': {'Declination': np.float64(45.59902976977015), 'RA': '15.24.09'}}`
...
star_chart_spherical_projection.position_over_time(star="Altair",
            ...
            is_precession=True)
```
Returns `{2000: {'RA (radians)': -1.0874854843260338, 'RA (hours)': '19.50.46', 'Dec (degrees)': np.float64(8.520199531975353)}, 12000: {'RA (radians)': 1.4428565057434115, 'RA (hours)': '05.30.41', 'Dec (degrees)': np.float64(52.1248474708539)}, 22000: {'RA (radians)': -2.197776589553731, 'RA (hours)': '15.36.18', 'Dec (degrees)': np.float64(13.075954490463758)}}`
